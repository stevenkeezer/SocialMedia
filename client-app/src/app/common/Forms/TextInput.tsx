...
export const Field = ({ field, props, className }) => (
  <input
    className={classNames(
      className ||
        "block w-full border px-2 py-2 bg-transparent border-transparent dark:border-transparent sm:text-sm text-gray-500 dark:text-white focus:ring-indigo-500 focus:border-indigo-500 dark:focus:border-[#424244] rounded-md"
    )}
    {...field}
    {...props}
  />
