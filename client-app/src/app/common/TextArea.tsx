    ...
    <div className="space-y-1 pl-2 pt-1 mr-6 sm:space-y-0">
      ...
      <div className="pt-1.5 pl-0.5">
        <TextareaAutosize
          ...
          className="block w-full min-h-[4.3rem] resize-none border px-3.5 outline-none break-words max-w-[39.1rem] py-[.525rem] sm:text-sm bg-transparent active:border-[#a2a0a2] dark:focus:border-[#a2a0a2] focus:border-[#6d6e6f] border-transparent hover:border-[#afabac] dark:hover:border-[#565557] rounded-md"
        />
      </div>
